...
public class SMILES2CMLPartitionAlgorithmSetSPITest {
	...
	public void testSPI() {
		...
		for (PartitionAlgorithmSetSPI p : list) {
			if (p instanceof SMILES2CMLPartitionAlgorithmSetSPI) {
				c++;
			}
		}
	...
	public void getPartitonAlgorithms() {
		PartitionAlgorithmSetSPI p = new SMILES2CMLPartitionAlgorithmSetSPI();
