...
public class SMILES2CMLPropertyExtractor implements PropertyExtractorSPI {

	public Map<String, Object> extractProperties(Object target) {
		Map<String,Object> map = new HashMap<String, Object>();
		if (target instanceof SMILES2CMLActivityItem) {
			SMILES2CMLActivityItem item = (SMILES2CMLActivityItem)target;
